...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">CP : +62 813-2423-0979</a>
        </div>
      </div>
  ...
  <footer class="main-footer">
    ...
    Copyright &copy;<a target="_blank" href=""><strong>Kelompok 4 A2022 STMIK Mardira Indonesia</strong></a>
    All rights reserved.
  </footer>
