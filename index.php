...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
		...
		<nav class="main-header navbar navbar-expand navbar-default navbar-light">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="?page=rekap_km" class="nav-link">Rekap Kas Mesjid</a>
				</li>
				<li class="nav-item d-none d-sm-inline-block">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="http://localhost/kas_masjid/" class="brand-link">
				...
				<span class="brand-text font-weight-light">DKL Baiturrahman</span>
			</a>
    ...
    ?>
		...
		<footer class="main-footer">
			...
			Copyright &copy;
				<strong>Kel. 4 STMIK Mardira Indonesia</strong>
			</a>
